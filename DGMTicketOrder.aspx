													...
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															...
															<td>
																...
																<div class="text"><span style="color:#64605a; font-family:'Libre Baskerville', Georgia, Times, 'Times New Roman', serif; font-size:16px; line-height:21px; text-align:left">Thank you! We look forward to your arrival at the Distillery and Gristmill.</span></div>
															...
															<td>
																...
																<table width="100%" border="0" cellspacing="0" cellpadding="0">
																	<tr>
																		...
																		<div class="text"><span style="color:#64605a; font-family:'Libre Baskerville', Georgia, Times, 'Times New Roman', serif; font-size:16px; line-height:21px; text-align:left">Show this confirmation or use the printable ticket we will send you shortly.</span></div>
											...
											<tr>
												...
												<td>
													...
													<div class="text-footer" style="color:#ffffff; font-family: 'Open Sans', Tahoma, Arial, sans-serif; font-size:16px; line-height:22px; text-align:left">
														5514 MOUNT VERNON MEMORIAL PARKWAY<br />
