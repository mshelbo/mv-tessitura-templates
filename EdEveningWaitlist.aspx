													...
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															...
															<td>
																...
																<div class="text"><span style="color:#64605a; font-family:'Libre Baskerville', Georgia, Times, 'Times New Roman', serif; font-size:16px; line-height:21px; text-align:left">Thank you for your interest in Educator's Evening: An Evening with Laurie Halse Anderson! </span></div>
															...
															<td>
																...
																<table width="100%" border="0" cellspacing="0" cellpadding="0">
																	<tr>
																		...
																		<div class="text"><span style="color:#64605a; font-family:'Libre Baskerville', Georgia, Times, 'Times New Roman', serif; font-size:16px; line-height:21px; text-align:left">You are now waitlisted for this program. We will contact waitlisted guests in order of request submission should space become available.</span></div>
