...
<%
    ...
    {
        Subject = "Thank You for Your Ticket Order";
    }
%>
													...
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															...
															<td>
																...
																<div class="h2" style="color:#59595b; font-family:Tahoma, Arial, sans-serif, 'Open Sans'; font-size:21px; line-height:25px; text-align:left; font-weight:bold">Dear <span id="name-first" style="text-transform: uppercase;"><%= OrderData.Customer.FirstName %></span>,</div>
																...
																<div class="text"><span style="color:#64605a; font-family:'Libre Baskerville', Georgia, Times, 'Times New Roman', serif; font-size:16px; line-height:21px; text-align:left">Thank you for supporting Mount Vernon by becoming a member. We look forward to your arrival at the home of George and Martha Washington.<br><br>
																As a member, you may enter the Mansion at any time and therefore do not require a timed ticket.</span></div>
																<table width="100%" border="0" cellspacing="0" cellpadding="0" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%"><tr><td height="18" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">&nbsp;</td></tr></table>
																			...
																			<table border="0" cellspacing="0" cellpadding="0">
																				<tr>
																					<td>
																						<div class="h5" style="color:#231f20; font-family:Tahoma, Arial, sans-serif, 'Open Sans'; font-size:15px; line-height:20px; text-align:left; text-transform:uppercase">
																							<a href="http://www.mountvernon.org/plan-your-visit/" target="_blank" class="link3" style="color:#3e3832; text-decoration:none"><span class="link3" style="color:#3e3832; text-decoration:none; font-weight:bold;">PLAN YOUR VISIT</span></a>
																						</div>
																						<div style="font-size:0pt; line-height:0pt; height:5px; background:#f0b336; "><img src="http://s3.amazonaws.com/mtv-main-assets/files/resources/tessitura-email_spacer.gif" width="1" height="5" style="height:5px" alt="" /></div>
															...
															<td>
																...
																<table width="100%" border="0" cellspacing="0" cellpadding="0">
																	<tr>
																		...
																		<div class="text"><span style="color:#64605a; font-family:'Libre Baskerville', Georgia, Times, 'Times New Roman', serif; font-size:16px; line-height:21px; text-align:left">Show this barcode to pick up your new membership card at the main entrance.</span></div>
																		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%"><tr><td height="20" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">&nbsp;</td></tr></table>
																			...
																			<div class="fluid-img2" style="font-size:0pt; line-height:0pt; text-align:left;">
																				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%"><tr><td height="18" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">&nbsp;</td></tr></table>
																				<div class="img-center" style="font-size:12pt; line-height:14pt; text-align:center; background-color: #fff;"><br /><img src="https://mtv-main-assets.s3.amazonaws.com/barcode/C128_<%= OrderData.OrderNumber %>.png" style="height: 100px !important; width: 114px !important;" height="100px" width="114px" /><br /><span id="order-number"><%= OrderData.OrderNumber %></span></div>
																			</div>
																...
																<!-- XLS -->			
																<%= TransformXml("~/templates/GenTicketOrder.xsl")%>	
