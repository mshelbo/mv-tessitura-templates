										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff"> 
											<tr>
												<td>
													...
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															...
															<td>
																...
																<div class="h2" style="color:#59595b; font-family:Tahoma, Arial, sans-serif, 'Open Sans'; font-size:21px; line-height:25px; text-align:left; font-weight:bold">Thank you for your reservation; we look forward to your visit!</div>
																...
																<div class="text"><span style="color:#64605a; font-family:'Libre Baskerville', Georgia, Times, 'Times New Roman', serif; font-size:16px; line-height:21px; text-align:left">Please review the following reservation details carefully and contact us as soon as possible with any adjustments.<br><br>
																To secure your reservation and hold your Mansion line entry time, final guest count and full payment must be received 7 days prior to arrival. After that date, your reservation will be released. You will receive a confirmation once payment has been processed.</span></div>
													...
													<td>
													<!-- XLS -->
													<%= TransformXml("~/templates/GroupReservation.xsl")%>
													</td>
													</tr>
													</table>
													...
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															...
															<td>																
																...
																<div class="h2" style="color:#59595b; font-family:Tahoma, Arial, sans-serif, 'Open Sans'; font-size:21px; line-height:25px; text-align:left; font-weight:bold">Payment Instructions:</div>
																<table width="100%" border="0" cellspacing="0" cellpadding="0" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%"><tr><td height="12" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">&nbsp;</td></tr></table>


																<div class="text"><span style="color:#64605a; font-family:'Libre Baskerville', Georgia, Times, 'Times New Roman', serif; font-size:16px; line-height:21px; text-align:left"><strong>Check</strong>: Please make checks payable to <strong>George Washington's Mount Vernon</strong>, write Order number on check, and mail with copy of this reservation to the address below.<br><br>
																
																<strong>Credit Card</strong>: Please print this reservation, add credit card details, and fax to 703.799.5238 or scan and email to grouptours@mountvernon.org.</span></div>
																<table width="100%" border="0" cellspacing="0" cellpadding="0" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%"><tr><td height="18" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">&nbsp;</td></tr></table>
															</td>							
													...
													<table style="width:100%; padding: 10px;">
														<tr style="background-color:#000;">
																<td style="width:50%">
																<div class="text" style="color:#FFF; font-family:Tahoma, Arial, sans-serif, 'Open Sans'; font-size:15px; line-height:25px; padding: 10px;">Payment Amount:</div>
																</td>
																<td style=width:50%">
																<div class="text" style="color:#FFF; font-family:Tahoma, Arial, sans-serif, 'Open Sans'; font-size:15px; line-height:25px; padding: 10px;">Card Type</div>
																</td>
														</tr>
														
														<tr>
																<td style="border: 1px solid #000; width:50%">
																<div class="text" style="color:#000; font-family:Tahoma, Arial, sans-serif, 'Open Sans'; font-size:15px; line-height:25px; padding: 10px;">$</div>
																</td>
																<td style="border: 1px solid #000; width:50%">
																<div class="text" style="color:#000; font-family:Tahoma, Arial, sans-serif, 'Open Sans'; font-size:15px; line-height:25px; padding: 10px;">Visa[ ] MasterCard[ ] Amex[ ] Discover[ ]</div>
																</td>
														</tr>
														
														<tr style="background-color:#000;">
																<td style="width:50%">
																<div class="text" style="color:#FFF; font-family:Tahoma, Arial, sans-serif, 'Open Sans'; font-size:15px; line-height:25px; padding: 10px;">Card Number:</div>
																</td>
																<td style="width:50%">
																<div class="text" style="color:#FFF; font-family:Tahoma, Arial, sans-serif, 'Open Sans'; font-size:15px; line-height:25px; padding: 10px;">Expiration Date:</div>
																</td>
														</tr>
														
														<tr>
																<td style="border: 1px solid #000; width:50%">
																<div class="text" style="color:#FFF; font-family:Tahoma, Arial, sans-serif, 'Open Sans'; font-size:15px; line-height:25px; padding: 10px;">$</div>
																</td>
																<td style="border: 1px solid #000; width:50%">
																<div class="text" style="color:#000; font-family:Tahoma, Arial, sans-serif, 'Open Sans'; font-size:15px; line-height:25px; padding: 10px;"></div>
																</td>
														...
														<tr style="background-color:#000;">
																<td style="width:50%">
																<div class="text" style="color:#FFF; font-family:Tahoma, Arial, sans-serif, 'Open Sans'; font-size:15px; line-height:25px; padding: 10px;">Name on Card:</div>
																</td>
																<td style="width:50%">
																<div class="text" style="color:#FFF; font-family:Tahoma, Arial, sans-serif, 'Open Sans'; font-size:15px; line-height:25px; padding: 10px;">Signature:</div>
																</td>
														</tr>
													...
													<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#f5f3ee" style="background-color: background-color: #f5f3ee;">
														<tr style="background-color: background-color: #f5f3ee;">
															<td class="content-spacing" style="font-size:0pt; line-height:0pt; text-align:left; background-color: #f5f3ee; color: #f5f3ee" width="52"></td>
															<td>
