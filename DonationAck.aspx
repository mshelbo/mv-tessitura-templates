													...
													<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#f5f3ee">
														<tr>
															...
															<td>															
																...
																<div class="text-list" style="color:#64605a; font-family: 'Open Sans', Tahoma, Arial, sans-serif; font-size:14px; line-height:28px; text-align:left">
											...
											<tr>
												...
												<td>
													...
													<div class="text-footer" style="color:#ffffff; font-family: 'Open Sans', Tahoma, Arial, sans-serif; font-size:16px; line-height:22px; text-align:left">
														...
														<a href="#" target="_blank" class="link-white" style="color:#ffffff; text-decoration:none"><span class="link-white" style="color:#ffffff; text-decoration:none">703.799.8647</span></a><br />
														<a href="mailto:supporthisvision@mountvernon.org" target="_blank" class="link-white" style="color:#ffffff; text-decoration:none"><span class="link-white" style="color:#ffffff; text-decoration:none">supporthisvision@mountvernon.org</span></a>
													</div>
