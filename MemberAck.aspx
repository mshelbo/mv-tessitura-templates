...
<%
    ...
    {
        Subject = "Thank You for Supporting Mount Vernon";
    }
%>
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff"> 
											<tr>
												<td>
													...
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															...
															<td>
																...
																<div class="text"><span style="color:#64605a; font-family:'Libre Baskerville', Georgia, Times, 'Times New Roman', serif; font-size:16px; line-height:21px; text-align:left">Thank you for supporting George Washington's Mount Vernon. Your membership was successfully processed. </span></div>
													...
													<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ebe8e0">
														<tr>
															...
															<td>
																...
																<table width="100%" border="0" cellspacing="0" cellpadding="0">
																	<tr>
																		<td>
																			...
																			<div class="text"><span style="color:#64605a; font-family:'Libre Baskerville', Georgia, Times, 'Times New Roman', serif; font-size:16px; line-height:21px; text-align:center">Show this barcode at the main entrance for quick entry.</span></div>																		
																		
																			<div class="fluid-img2" style="font-size:0pt; line-height:0pt; text-align:left;">
																				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%"><tr><td height="18" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">&nbsp;</td></tr></table>
																				<div class="img-center" style="font-size:12pt; line-height:14pt; text-align:center; background-color: #fff;"><br /><img src="https://mtv-main-assets.s3.amazonaws.com/barcode/C128_M000<%= ConstituentInfo.ConstituentHeader.customer_no %>.png" style="height: 100px !important; width: 114px !important;" height="100px" width="114px" /><br /><span id="order-number"><%= ConstituentInfo.ConstituentHeader.customer_no %></span></div>
																			</div>
																...
																<span style="color:#8d2838; font-size:24px; font-weight: bold"><%= OrderData.OrderDate.ToString("MM/dd/yyyy") %></span>
																</p>																			
																		</td>
																	</tr>
																</table>
													...
													<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#f5f3ee">
														<tr>
															...
															<td>
																...
																<div class="text-list" style="color:#64605a; font-family: 'Open Sans', Tahoma, Arial, sans-serif; font-size:15px; line-height:28px; text-align:left">
																	Members save online and in-store at the Shops at Mount Vernon. <a href="http://www.mountvernon.org/memberdiscount" style="color:#64605a; text-decoration: underline;">Get your coupon code to shop online and save</a>.<br><br>
																	
																	Check out our <a href="http://www.mountvernon.org/calendar" style="color:#64605a; text-decoration: underline;">upcoming events</a> and plan your visit today.<br><br>
																	
																	For IRS purposes, your gift is tax-deductible to the extent allowed by law. George Washington's Mount Vernon is a 501 ( c ) (3) not-for-profit organization. Federal Tax ID # 54-0564701.
																</div>
																<table width="100%" border="0" cellspacing="0" cellpadding="0" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%"><tr><td height="26" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">&nbsp;</td></tr></table>
											...
											<tr>
												...
												<td>
													...
													<div class="text-footer" style="color:#ffffff; font-family: 'Open Sans', Tahoma, Arial, sans-serif; font-size:16px; line-height:22px; text-align:left">
														...
														<a href="#" target="_blank" class="link-white" style="color:#ffffff; text-decoration:none"><span class="link-white" style="color:#ffffff; text-decoration:none">703.780.2000</span></a><br />
														<a href="mailto:membership@mountvernon.org" target="_blank" class="link-white" style="color:#ffffff; text-decoration:none"><span class="link-white" style="color:#ffffff; text-decoration:none">membership@mountvernon.org</span></a>
													</div>
														...
														<tr>
															<td align="left">
																...
																<table border="0" cellspacing="0" cellpadding="0">
																	<tr>
																		<td class="img" style="font-size:0pt; line-height:0pt; text-align:left" width="53"><a href="#" target="_blank"><img src="http://s3.amazonaws.com/mtv-main-assets/files/resources/tessitura-email_ico_facebook.jpg" border="0" width="30" height="30" alt="" /></a></td>
																		<td class="img" style="font-size:0pt; line-height:0pt; text-align:left" width="53"><a href="#" target="_blank"><img src="http://s3.amazonaws.com/mtv-main-assets/files/resources/tessitura-email_ico_twitter.jpg" border="0" width="36" height="30" alt="" /></a></td>
																		<td class="img" style="font-size:0pt; line-height:0pt; text-align:left" width="53"><a href="#" target="_blank"><img src="http://s3.amazonaws.com/mtv-main-assets/files/resources/tessitura-email_ico_instagram.jpg" border="0" width="30" height="30" alt="" /></a></td>
																		<td class="img" style="font-size:0pt; line-height:0pt; text-align:left" width="53"><a href="#" target="_blank"><img src="http://s3.amazonaws.com/mtv-main-assets/files/resources/tessitura-email_ico_youtube.jpg" border="0" width="43" height="30" alt="" /></a></td>
																		<td class="img" style="font-size:0pt; line-height:0pt; text-align:left" width="33"><a href="#" target="_blank"><img src="http://s3.amazonaws.com/mtv-main-assets/files/resources/tessitura-email_ico_vimeo.jpg" border="0" width="33" height="30" alt="" /></a></td>
																	</tr>
																</table>
															</td>
														</tr>
